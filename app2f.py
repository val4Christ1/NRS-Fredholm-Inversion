...
fig = plt.figure(figsize=(20, 12), dpi=plot_dpi)
...
ax1.set_title("Magnetic Resonance Signal", fontsize=18, fontweight='bold')
...
ax2.set_title("True f(T₁, T₂)", fontsize=18, fontweight='bold')
ax2.tick_params(axis='both', labelsize=14)
cbar1 = plt.colorbar(cp1, ax=ax2)
...
ax3.set_ylabel("T₁ (s)", fontsize=16)
ax3.set_title(f"Reconstructed f(T₁, T₂) - {reg_method}", fontsize=18, fontweight='bold')
ax3.tick_params(axis='both', labelsize=14)
cbar2 = plt.colorbar(cp2, ax=ax3)
...
ax4.set_ylabel("f(T₁)", fontsize=16)
ax4.legend(fontsize=14)
ax4.set_title("Marginal Distribution f(T₁)", fontsize=18, fontweight='bold')
...
ax5.set_ylabel("f(T₂)", fontsize=16)
ax5.legend(fontsize=14)
ax5.set_title("Marginal Distribution f(T₂)", fontsize=18, fontweight='bold')
...
ax6.set_xlabel("log₁₀(T₂)", fontsize=16)
ax6.set_ylabel("log₁₀(T₁)", fontsize=16)
ax6.set_title("Normalized Residual (|f_rec - f_true|/max)", fontsize=18, fontweight='bold')
